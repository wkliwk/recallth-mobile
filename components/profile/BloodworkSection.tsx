            ...
            <>
              ...
              {topInterpretations.map((item) => (
                <View key={item.marker} style={styles.interpretRow}>
                  <View style={[styles.priorityDot, { backgroundColor: item.priority === 'high' ? colors.danger : item.priority === 'medium' ? colors.warning : colors.ok }]} />
...
const styles = StyleSheet.create({
  ...
  interpretEmpty: { fontSize: 12, color: colors.text3, fontStyle: 'italic' },
  overallSummary: {
    fontSize: 13,
    color: colors.text,
    lineHeight: 18,
  ...
  interpretMarker: { fontSize: 13, fontWeight: '600', color: colors.text },
  interpretStatus: { fontWeight: '400', color: colors.text2 },
  interpretInsight: { fontSize: 12, color: colors.text2, lineHeight: 17, marginTop: 2 },
  interpretRec: { fontSize: 12, color: colors.primary, marginTop: 2, fontWeight: '500' },
});
